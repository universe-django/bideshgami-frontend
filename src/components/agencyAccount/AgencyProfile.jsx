      ...
      <div className="w-full bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to={"profile-edit"}>
            <Button className="flex gap-2 px-4 py-2 text-sm border-2 rounded-md">
              <WriteIcon />
              Edit
            </Button>
          </Link>
