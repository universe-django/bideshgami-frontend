...
export default function AgentSuccessFile() {
      ...
      <div className="bg-white rounded-lg p-6">
        <div className="flex justify-between mb-10 ">
          <div className="flex">
            ...
            <Input
              placeholder="Search"
              className={"ms-3 bg-transparent border border-gray-300 "}
            />
          </div>
          <p className="text-2xl bg-white/60 p-2 rounded-lg font-bold text-blue-500">
            Balance 500000000 BDT
          </p>
        </div>
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-44  space-y-2 me-2 p-2">
                      <DropdownMenuItem className="cursor-pointer  text-center text-black">
                        View Details
                      </DropdownMenuItem>
                      <DropdownMenuItem className="cursor-pointer e text-center text-black">
                        View Documents
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
