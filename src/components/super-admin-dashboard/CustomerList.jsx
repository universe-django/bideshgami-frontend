        ...
        <Table className="min-w-full">
          <TableHeader className="bg-gray-100">
            <TableRow>
              ...
              <TableHead>Form & To</TableHead>
              <TableHead>Type Of Visa</TableHead>
              <TableHead>RL Or HL</TableHead>
          ...
          <TableBody>
            <TableRow className="hover:bg-gray-50 transition">
              ...
              <TableCell>U&Y665555</TableCell>
              <TableCell>2,90,000</TableCell>
              <TableCell>GH33434</TableCell>
            ...
            <TableRow className="hover:bg-gray-50 transition">
              ...
              <TableCell>BR9988776</TableCell>
              <TableCell>01799887766</TableCell>
              <TableCell>Dhaka → Dubai</TableCell>
              <TableCell>Visit Visa</TableCell>
              <TableCell>R&L223311</TableCell>
              <TableCell>1,50,000</TableCell>
              <TableCell>IN77654</TableCell>
              <TableCell className="text-center">
                <DropdownMenu>
                  <DropdownMenuTrigger>
                    <EllipsisVertical className="text-gray-600 hover:text-gray-800" />
