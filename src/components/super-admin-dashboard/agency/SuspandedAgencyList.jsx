...
export default function SuspandedAgencyList() {
              ...
              {activeAgencyList.map((list) => (
                ...
                >
                  ...
                  <TableCell className="p-2">
                    <p className={`bordertext-center text-emerald-600 font-semibold tracking-tight text-sm ${list.status !== "active" && "text-red-500"}`}>
                      {list.status}
                    </p>
                  </TableCell>
